#this code is updated from get_fixed_glmnet to consider parallel
# within each drug

# Think about the rationale by checking this post:
...
glm_grid <- grid_latin_hypercube(glm_param,size = 10)
