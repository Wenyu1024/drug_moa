...
I will use ROCR package  (check ROCR.hiv in ROCR package reference manual)

```{r}
get_ave_roc <- function(annotated_pred_df, title, addlegend= T,label_level= 0){
  library(ROCR)
...
get_ave_roc(CTRP_binary_PPIold_data, title = "CTRP", addlegend = F)
get_ave_roc(GDSC_binary_PPIold_data, title = "GDSC")
