...
save.image("/home/cloud-user/cluster_scratch/ces_21q1_io/ces_prepare_21q1_intermediate.RData")
# load("/home/cloud-user/cluster_scratch/ces_io/ces_prepare_21q1_intermediate.RData")

# The following calculation can be put on a server
